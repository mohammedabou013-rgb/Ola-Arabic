...
export const indonesiaGrade2: GradeData = {
  ...
  units: [
    u(1, "أَفْرَادُ الْمَدْرَسَةِ", "School Members", "Ahli Sekolah", "Anggota Sekolah", "Les membres de l’école", "Los miembros de la escuela", "school-members", [
      l(1, 1, "أَفْرَادُ الْمَدْرَسَةِ", "School Members", "Ahli Sekolah", "Anggota Sekolah", "Les membres de l’école", "Los miembros de la escuela",
    ...
    u(2, "الْأَدَوَاتُ الْمَدْرَسِيَّةُ", "School Tools", "Alat Sekolah", "Alat Sekolah", "Les outils scolaires", "Los útiles escolares", "school-tools", [
      l(2, 1, "الْأَدَوَاتُ الْمَدْرَسِيَّةُ", "School Tools", "Alat Sekolah", "Alat Sekolah", "Les outils scolaires", "Los útiles escolares",
    ...
    u(3, "فِي الْفَصْلِ", "In the Classroom", "Di Dalam Kelas", "Di Dalam Kelas", "Dans la classe", "En el aula", "classroom", [
      l(3, 1, "فِي الْفَصْلِ", "In the Classroom", "Di Dalam Kelas", "Di Dalam Kelas", "Dans la classe", "En el aula",
    ...
    u(4, "الْأُسْرَةُ وَالْبَيْتُ", "Family and Home", "Keluarga dan Rumah", "Keluarga dan Rumah", "La famille et la maison", "La familia y la casa", "family-home", [
      l(4, 1, "الْأُسْرَةُ وَالْبَيْتُ", "Family and Home", "Keluarga dan Rumah", "Keluarga dan Rumah", "La famille et la maison", "La familia y la casa",
    ...
    u(5, "الْحَيَوَانَاتُ وَالطَّبِيعَةُ", "Animals and Nature", "Haiwan dan Alam", "Hewan dan Alam", "Les animaux et la nature", "Los animales y la naturaleza", "animals-nature", [
      l(5, 1, "الْحَيَوَانَاتُ وَالطَّبِيعَةُ", "Animals and Nature", "Haiwan dan Alam", "Hewan dan Alam", "Les animaux et la nature", "Los animales y la naturaleza",
    ...
    u(6, "الْأَرْقَامُ وَالْعَدُّ", "Numbers and Counting", "Nombor dan Mengira", "Angka dan Menghitung", "Les nombres et le comptage", "Los números y el conteo", "numbers", [
      l(6, 1, "الْأَرْقَامُ وَالْعَدُّ", "Numbers and Counting", "Nombor dan Mengira", "Angka dan Menghitung", "Les nombres et le comptage", "Los números y el conteo",
...
function l(unitOrder:number, order:number, ar:string, en:string, ms:string, id:string, fr:string, es:string, vocab:any[], dialogue:any[], exercises:any[]): Lesson {
  const unit = `indonesia-g2u${unitOrder}`;
  const mappedExercises = exercises.map((e:any, i:number) => ({ id:`indonesia-g2u${unitOrder}l${order}e${i+1}`, ...e }));
  if (!mappedExercises.some((e:any) => e.type === 'arrange')) {
    const sentence = dialogue.length > 0 ? dialogue[0][1] : (vocab.length > 0 ? `هٰذَا ${vocab[0][0]}` : '');
    if (sentence) {
      mappedExercises.push({
        id: `indonesia-g2u${unitOrder}l${order}e${mappedExercises.length + 1}`,
        type: 'arrange',
        skill: 'reading',
  ...
  return {
    ...
    vocabulary: vocab.map((v, i) => ({ id:`indonesia-g2u${unitOrder}l${order}v${i+1}`, arabic:v[0], transliteration:v[1], translation:t(v[0],v[1],v[2],v[3],v[4],v[5]), emoji:v[6] })),
...
function ex(type:any, skill:any, prompt:any, a?:any, b?:any, c?:any, d?:any, e?:any) {
  ...
  const answer = (type === 'writing' || type === 'arrange' || type === 'fill_in_blank') ? (arabicText ?? null) : null;
  return { type, skill, prompt, options, correctIndex, imageUrl: imageUrl ?? null, arabicText: arabicText ?? null, pairs, answer };
}